...
export default function HomePage() {
  ...
  return (
    <div className="min-h-screen bg-brand-bg">
      ...
      {/* HERO — text only; yellow title “Work-Based Learning.” */}
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div className="space-y-8">
              ...
              <h1 className="text-5xl lg:text-6xl font-extrabold leading-tight">
                <span className="text-brand-yellow">Work-Based Learning.</span>
              </h1>
            ...
            {/* Right column intentionally left empty to remove the centered logo card */}
            <div />
          </div>
        </div>
      </section>
              ...
              <div key={program.id} className="group bg-white rounded-2xl shadow-lg hover:shadow-2xl transition-all duration-500 transform hover:-translate-y-2 overflow-hidden">
                ...
                <div className="p-8">
                  ...
                  <div className="flex gap-3">
                    <a
                      href={`${APPLY_BASE}?program=${program.id}`}
                      target="_blank" rel="noopener noreferrer"
...
echo "✅ Updated homepage. Restart dev server:"
